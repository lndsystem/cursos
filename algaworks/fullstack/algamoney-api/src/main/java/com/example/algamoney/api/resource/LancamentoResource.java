...
public class LancamentoResource {
	...
	@GetMapping("/{codigo}")
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_CATEGORIA') and #oauth2.hasScope('read')")
	public ResponseEntity<?> pesquisarPorId(@PathVariable Long codigo) {
		return ResponseEntity.ok(lancamentoRepository.findById(codigo).orElseThrow(() -> new EmptyResultDataAccessException(1)));
	}
